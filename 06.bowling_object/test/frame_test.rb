...
class FrameTest < Minitest::Test
  def test_score_no_bonus
    frames = Array.new(10) do |idx|
      idx == 9 ? Frame.new(idx, 'X', 'X', '1') : Frame.new(idx, '1', '5')
    end
  ...
  def test_score_spare
    frames = Array.new(10) do |idx|
      idx.zero? ? Frame.new(idx, '1', '9') : Frame.new(idx, '1', '5')
    end
  ...
  def test_score_single_strike
    frames = Array.new(10) do |idx|
      idx.zero? ? Frame.new(idx, 'X') : Frame.new(idx, '1', '5')
    end
  ...
  def test_score_double_strike
    frames = Array.new(10) do |idx|
      idx < 2 ? Frame.new(idx, 'X') : Frame.new(idx, '1', '5')
    end
